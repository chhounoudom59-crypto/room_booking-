...
def ingest_document(
    ...
    try:
        ...
        loader = LangChainDocumentLoader(chunk_size=chunk_size, chunk_overlap=chunk_overlap, splitter_type="recursive")

        chunks = loader.load_and_chunk_file(file_path, user_id=user_id, extra_metadata=extra_metadata)
