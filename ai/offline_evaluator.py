...
class OfflineEvaluator:
    def __init__(self, retriever=None, eval_llm_client=None, output_dir: str = "./eval_results"):
        ...
        logger.info("   NOTE: This runs OFFLINE only, never during runtime inference")
    ...
    def _evaluate_output(
        ...
        # 3. Combine metrics
        overall_quality = 0.4 * retrieval_metrics.get("f1_score", 0.5) + 0.6 * generation_metrics.get(
...
Respond with ONLY the score."""
    ...
    def _evaluate_completeness(self, response: str, entities: Dict | None = None) -> float:
