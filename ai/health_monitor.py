    ...
    def check_connectivity(self) -> Dict:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {"status": "healthy", "latency": latency, "timestamp": datetime.now().isoformat()}
                ...
                return {"status": "auth_failed", "message": error_msg, "timestamp": datetime.now().isoformat()}
                ...
                return {"status": "rate_limited", "message": error_msg, "timestamp": datetime.now().isoformat()}
            ...
            return {"status": "timeout", "message": error_msg, "timestamp": datetime.now().isoformat()}
            ...
            self.stats["failed_requests"] += 1
            logger.error(f"🔌 {error_msg}")
            return {"status": "no_connection", "message": error_msg, "timestamp": datetime.now().isoformat()}
            ...
            return {"status": "unknown_error", "message": str(e), "timestamp": datetime.now().isoformat()}
