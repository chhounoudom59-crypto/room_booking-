...
urlpatterns = [
    ...
    path(
        "admin/rooms/<int:room_id>/toggle-availability/",
        admin_views.admin_room_toggle_availability,
        name="admin_room_toggle_availability",
    ),
    ...
    path(
        ...
        admin_views.admin_booking_update_status,
    ...
    path(
        ...
        admin_views.admin_announcement_edit,
        name="admin_announcement_edit",
    ),
    path(
        "admin/announcements/<int:announcement_id>/delete/",
        admin_views.admin_announcement_delete,
        name="admin_announcement_delete",
    ),
    path(
        "admin/announcements/<int:announcement_id>/toggle-active/",
        admin_views.admin_announcement_toggle_active,
        name="admin_announcement_toggle_active",
    ),
    # Admin user management
    path("admin/users/", admin_views.admin_user_management, name="admin_user_management"),
    path(
        "admin/users/<int:user_id>/toggle-status/",
        admin_views.admin_user_toggle_status,
    ...
    path(
        "admin/bookings/<int:booking_id>/quick-edit/",
        admin_views.admin_booking_quick_edit,
        name="admin_booking_quick_edit",
    ),
    # User dashboard
