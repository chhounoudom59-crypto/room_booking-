...
class CustomUserCreationForm(UserCreationForm):
    ...
    student_id = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Lecturer ID (optional)", "id": "studentId"}
        ),
    )
    ...
    phone_number = forms.CharField(
        ...
        required=False,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Phone Number (optional)", "id": "phoneNumber"}
        ),
    )
    ...
    faculty = forms.CharField(
        max_length=100,
        required=False,
        widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "Faculty (optional)", "id": "faculty"}),
    )
    ...
    department = forms.CharField(
        ...
        required=False,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Department (optional)", "id": "department"}
        ),
    )
...
class CustomLoginForm(forms.Form):
    ...
    email = forms.EmailField(
        widget=forms.EmailInput(
            attrs={"class": "form-control", "placeholder": "Email Address", "id": "username", "name": "username"}
        )
    )
...
class CustomPasswordChangeForm(PasswordChangeForm):
    ...
    old_password = forms.CharField(
        widget=forms.PasswordInput(
            attrs={"class": "form-control", "placeholder": "Current password", "id": "currentPassword"}
        )
    )

    new_password1 = forms.CharField(
        widget=forms.PasswordInput(attrs={"class": "form-control", "placeholder": "New password", "id": "newPassword"})
    )

    new_password2 = forms.CharField(
        widget=forms.PasswordInput(
            attrs={"class": "form-control", "placeholder": "Confirm new password", "id": "confirmPassword"}
        )
    )
    ...
    class Meta:
        ...
        widgets = {
            ...
            "student_id": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Lecturer ID", "id": "studentId"}
            ),
            ...
            "faculty": forms.TextInput(attrs={"class": "form-control", "placeholder": "Faculty", "id": "faculty"}),
            "department": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Department", "id": "department"}
            ),
        }
