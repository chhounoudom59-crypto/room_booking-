...
urlpatterns = [
    ...
    path(
        "admin/ajax/users/<int:user_id>/toggle-status/", views.ajax_toggle_user_status, name="ajax_toggle_user_status"
    ),
    path("admin/ajax/rooms/<int:room_id>/delete/", views.ajax_delete_room, name="ajax_delete_room"),
    path(
        "admin/ajax/rooms/<int:room_id>/toggle-availability/",
        views.ajax_toggle_room_availability,
        name="admin_toggle_room_availability",
    ),
    ...
    path(
        "admin/ajax/rooms/<int:room_id>/toggle-availability/",
        views.ajax_toggle_room_availability,
        name="ajax_toggle_room_availability",
    ),
